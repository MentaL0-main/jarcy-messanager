...
type RegisterResponse struct {
	...
	ExpiresAt     *timestamppb.Timestamp `protobuf:"bytes,5,opt,name=expires_at,json=expiresAt,proto3" json:"expires_at,omitempty"` // token expiration time
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_auth_auth_proto_rawDesc = "" +
	"\n" +
	"\x0fauth/auth.proto\x12\x04auth\x1a\x1fgoogle/protobuf/timestamp.proto\"\xe5\x01\n" +
	"\x04User\x12\x0e\n" +
	...
	".auth.UserR\x04user2s\n" +
	"\x04Auth\x129\n" +
	"\bRegister\x12\x15.auth.RegisterRequest\x1a\x16.auth.RegisterResponse\x120\n" +
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponseB'Z%github.com/Lemper29/Jarcy/gen/go/authb\x06proto3"
...
var file_auth_auth_proto_depIdxs = []int32{
	...
	5, // 3: auth.RegisterResponse.expires_at:type_name -> google.protobuf.Timestamp
